           ...
           tarea
            ...
            <form action="Controller" method="post">
                <table>
                    <tr>
                        <td>Id</td>
                        <td><imput type="text" name="id"value="<jsp:getProperty name="miTarea" property="id"/>"></td>
                     </tr>
                     <tr>
                         <td>Tarea</td>
                        <td><imput type="text" name="tarea" value="<jsp:getProperty name="miTarea" property="tarea"/>"/></td>
                     </tr>
                     <tr>
                         <td>Prioridad</td>
                         <td>
